      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-lg-6 text-center mx-auto">
            ...
            <h1 class="heading mb-3">Doctor's </h1>
            <p class="mb-5">Stay updated with expert insights on Covid-19 vaccination and testing through our healthcare blog. Access valuable information on vaccine efficacy, safety guidelines, and testing procedures. Learn about herd immunity, vaccine distribution strategies, and ways to protect yourself. Join us in promoting public health and combating the virus.</p>
          </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-lg-7 mx-auto text-center">
            <h2 class="mb-4 section-heading">Covid Vacciation Testing Doctor's</h2>
            <p>Doctor's blog: Covid vaccination aur testing ke naye updates se avagat rahein, aapki suraksha aur jankari ke liye.</p>
          </div>
        </div>

        <div class="container">
  <div class="row text-center position-center">
    <?php
